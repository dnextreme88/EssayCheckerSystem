...
<?php
    ...
    if (isset($_POST['submitessay'])) {
        ...
        echo "<script>window.location.href = 'StudentEssayResult.php';</script>";
    }
?>
<html>
    ...
    <div id="container">
        ...
        <fieldset id="myClassroom" style="height: auto;">
            ...
            <form method="post" action="#">
                <a href="StudentClassroom.php" style="color: buttonface;">Back</a>
                <br />

                <label>Essay Title:</label>
                <br /><br />
                <input type="text" name="essaytitle" value="<?= $essaytitle ?>" maxlength="500" style="width: 750px;" disabled />
                <br /><br />
