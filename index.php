    ...
    <body background="bg.jpg">
        <div id="container" >
            ...
            <fieldset id="infodiv">
                ...
                <label style="font-size:30px;">Welcome to Vanguard  <br>Essay Checker</label><br><br>
                <label>the best place to connect teacher and student thoughts</label><br>
                
            </fieldset>
            <fieldset id="register">
                <form method="post" action='#'>
                <label>Easy and Fast Registration</label><br><br>
                 <label>Username</label><br>
                <input type="text" name="newuser" maxlength="50" placeholder="Username" style="width:250px;padding:5px;"/><br><br>
                 <label>Password</label><br>
              <input type="password" name="newpass" maxlength="50" placeholder="Password" style="width:250px;padding:5px;"/><br><br>
               <label>Confirm Password</label><br>
              <input type="password" name="confirmpass" maxlength="50" placeholder="Confirm Password" style="width:250px;padding:5px;"/><br><br>
              
               <input type="radio" name="role" value="STUDENT" checked>I'm a Student
               <input type="radio" name="role" value="TEACHER">I'm a Teacher<br><br>
