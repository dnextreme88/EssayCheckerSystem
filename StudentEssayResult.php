...
<html>
    ...
    <body>
        ...
        <fieldset  id="myClassroom" style="height: auto;">
           ...
           <br><br><label><b>Your Essay Status:  </b>Submitted (If you don't click the compute score button your score will be zero) </label><br>
           
            <textarea cols="100" roWs="10" name="test2" id="test2" readonly><?php echo $studentessay; ?></textarea><br><br>
            <input type='submit' name='checkresult' value='Compute Score' onclick="showDiv()"/><br>
            
            <div id="welcomeDiv"  style="display:none;" class="answer_list" >
            
            <label><b>Match Word Summary : </b></label><br><Br>
            <label style="color:red">NOTE : Common Words/Stopwords are not counted in both Teacher and Student Word Count!</label><br>
            <label>Teacher Word Count : <?php echo $teachercount; ?></label><br>
            <label>Student Word Count : <?php echo $studentcount; ?></label><br>
            <label>Match Words Count : <?php echo $matchwordDisplay; ?></label><br>
            <label>Match Words Score(<?php echo $mwsPercentage;?>%) : </label><input type="number" name="ave" id="ave" readonly value='<?php echo $ave; ?>'/><br><br>
            
            <label><b>Grammar & Spelling Summary : </b></label><br><Br>
            <label>Wrong Spelling & Bad Usage : </label><br><textarea cols='50' rows='5' name="essaysummary" readonly id="essaysummary"></textarea><br>
            <br>
            <label>Grammar Score (<?php echo $gsPercentage;?>%) : </label><input type="text" max="100" min="0" name="essayscore" readonly id="essayscore" /><br>
            <br>
            <label>Total Score (GS + MWS): </label><input type="text" name="total" id="total" readonly/><br>
            </div>
            </form>
