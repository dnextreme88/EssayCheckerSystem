...
<?php
    ...
    if (isset($_POST['removeclass'])) {
        ...
        echo "<script>alert('Class Remove Successfully!');</script>";
    }
?>
<html>
                            ...
                            <tr>
                                ...
                                <?php if ($arrCount <= $num_rows): ?>
                                    <td id="tdstyle">
                                        ...
                                        <input type="image" onclick="return confirm('Are you sure you want to delete this class?')" src="img/remove.png" name="removeclass" value="<?= $rows['class_id'] ?>" style="height: 15px; width: 15px; margin-top: 50px;" /><label style="color: gray; font-size: 12px;">Remove</label>
                                    </td>
