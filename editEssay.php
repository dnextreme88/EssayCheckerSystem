         ...
         <div id="container" >
            ...
            <fieldset id="teachprofile">
             ...
             <fieldset id="myClassroom" style="height: auto;">
                 ...
                 <input type="text" name="essaytitle" placeholder="Essay Title" value="<?php echo $edit_title; ?>" maxlength="500" style="width:750px;" required/><br><br>
                 <label>Your Essay for this title:</label><br><br>
                 <textarea name="essaycontent" placeholder="Maximum of 1500 Characters!" maxlength="1500" style="width:745px;height: 150px;background:white;border-radius: 5px;" required><?php echo $edit_content; ?></textarea>
                 <br>
                 <label>Match Word Score Percentage:</label><br>
                 <input type="number" name="mws" id="mws" value="<?php echo $edit_mws; ?>" style="width:80px;"/> %
                 <br>
                 <label>Grammar & Spelling Score Percentage:</label><br>
                 <input type="number" name="gs" id="gs" value="<?php echo $edit_gs; ?>" style="width:80px;"/> %
                 <br>
                 <br>
