...
if(isset($_POST['myClass'])){
     ...
     echo "<script>
         ...
         window.location.href='StudentClassroom.php';    
        </script>";   
}
                         ...
                         <tr>
                            ...
                            if($arrCount <= $num_rows){ ?>
                                ...
                                <label>Code:<?php echo $rows['class_id']?></label><br>
                                 <label style="font-size: 12px;">Teacher: <?php echo $rows['teacher']?></label><br>
                                <textarea id='tbllbl' disabled><?php echo $rows['class_name']?></textarea>
                                <br><input type="image" onclick="return confirm('Are you sure to leave this class?')" src="img/remove.png" name ="removeclass" value='<?php echo $rows['class_id']?>' style="height:15px;width:15px;margin-top:50px;"/><label style="color:gray;font-size: 12px;">Remove</label>
                                </td>
                            <?php
