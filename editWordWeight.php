            ...
            <fieldset id="teachprofile">
             ...
             <fieldset id="myClassroom" style="height: auto;">
                 ...
                 <form method="post" action="#">
                     ...
                     <br>&nbsp;<button class="success"><a href="createEssay.php" style="text-decoration:none;color:white;">Back</a></button></br></br>
                 <label>Essay Title:</label><br><br>
                 <input type="text" name="essaytitle" placeholder="Essay Title" value="<?php echo $edit_title; ?>" maxlength="500" style="width:750px;" disabled/><br><br>
                 <label>Keyword : </label>
                 <input type="text" name="kw" id="kw" required/>
                 <label> Score : </label>
                 <input type="number" name="kws" id="kws" value="1" required/>
                 <input type="submit" class="success" name="add" value="Add Keyword" /><br><br>
                  ...
                  <?php
                        ...
                        ?>
                         <tr>
                             ...
                             <td style='font-size: 14px;padding:3px;width:300px;border-bottom: 1px solid gray;'><?php echo $rowclass['essay_kw']; ?></td>
                             <td style='font-size: 14px;padding:3px;width:100px;border-bottom: 1px solid gray;'><?php echo $rowclass['kw_score']; ?></td>
                             <td style='border-bottom: 1px solid gray;'><input type="image" src="img/remove.png" onclick="return confirm('Are you sure to delete this keyword?')" name="essayremove" value="<?php echo $rowclass['essay_kw_id']; ?>" style="width:13px;height: 13px"/></td>
                         <br>
                         </tr>
