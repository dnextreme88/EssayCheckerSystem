        ...
        <div id="container" >
            ...
            <fieldset id="teachprofile">
                  <form method="post" action="#" enctype="multipart/form-data">
                      ...
                      <input type="file" name="image" id="image"   onchange="readURL(this);" required style="position:absolute;margin-left: -120px"/><br><br>
                        <input type ="submit" value="Upload Image" name="uploadimage" class="success" style="width: 235px;margin-top:10px;">
